...
# Unix progs:    $AWK, rm
#
pscoast -Rd -JX8id/5id -Dc -Gblack -Sblue -E200/40 -K -U"Example 10 in Cookbook" \
   >! example_10.ps
psxyz agu.d -R-180/180/-90/90/0.000001/0.0001 -J -JZ2.5il  -Ggreen -W2.5p,white -O -K -E200/40 \
