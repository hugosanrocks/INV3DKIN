         subroutine model_hypo(green_mesh)
         ...
         do k=1,green_mesh%interp_i
          do i=1,green_mesh%msub
            ...
            !Distance to prior information
            vec2(1,1) = green_mesh%model2p(n1) - green_mesh%model2(n1)
            vec2(1,2) = green_mesh%model2p(n2) - green_mesh%model2(n2)
            green_mesh%slipr2(k,i) = vec2(1,1)
            green_mesh%slipr2(k,i+green_mesh%msub) = vec2(1,2)
          enddo
         enddo

         call cov_hypo(green_mesh)
