       ...
       INTEGER*8 simsam, slipsam, interp_i, interpadj_i      	! Samples of: simulation, slip, forward interpolation, adjoint simulation
       INTEGER*4 delays                              		! Number of samples of delay (given by origin time of the force appli
								! to compute Green's functions)
       INTEGER tfft_i                                           ! Samples of traction array in frequency domain
