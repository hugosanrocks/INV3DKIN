      subroutine  interp_dwn(proc_mesh)
...
!        Variables used in this subroutine
         ...
         REAL x(2), y(2), interp(6)
         INTEGER ii, jj, cont, cont2, i, j8, j9, j, reclen, iunit, iunit2
...
!        Interpolation if simulation_dt is less than slip-rate_dt
         ...
         cont2=2                               ! Counter
         t_sim= 0.  !proc_mesh%simdt different from DG input fiie  ! first time sample (simulation)
